...
document.getElementById('statName4').innerHTML = current.stats[3].stat.name;
document.getElementById('base_stat4').innerHTML = current.stats[3].base_stat;
document.getElementById('effort4').innerHTML = current.stats[3].effort;
document.getElementById('statName5').innerHTML = current.stats[4].stat.name;
document.getElementById('base_stat5').innerHTML = current.stats[4].base_stat;
document.getElementById('effort5').innerHTML = current.stats[4].effort;
document.getElementById('statName6').innerHTML = current.stats[5].stat.name;
document.getElementById('base_stat6').innerHTML = current.stats[5].base_stat;
document.getElementById('effort6').innerHTML = current.stats[5].effort;
document.getElementById('slot').innerHTML = current.types[0].slot;
document.getElementById('type').innerHTML = current.types[0].type.name;
document.getElementById('slot1').innerHTML = current.types[1].slot;
document.getElementById('type1').innerHTML = current.types[1].type.name;
document.getElementById('weight').innerHTML = current.weight;
//charmander
